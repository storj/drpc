...
type drpcEncoding_File_servicedefs_proto struct{}

func (drpcEncoding_File_servicedefs_proto) Marshal(msg drpc.Message) ([]byte, error) {
	return proto.Marshal(msg.(proto.Message))
}

func (drpcEncoding_File_servicedefs_proto) MarshalAppend(buf []byte, msg drpc.Message) ([]byte, error) {
	return proto.MarshalOptions{}.MarshalAppend(buf, msg.(proto.Message))
}

func (drpcEncoding_File_servicedefs_proto) Unmarshal(buf []byte, msg drpc.Message) error {
	return proto.Unmarshal(buf, msg.(proto.Message))
}

func (drpcEncoding_File_servicedefs_proto) JSONMarshal(msg drpc.Message) ([]byte, error) {
	return protojson.Marshal(msg.(proto.Message))
}

func (drpcEncoding_File_servicedefs_proto) JSONUnmarshal(buf []byte, msg drpc.Message) error {
...
func (c *drpcServiceClient) Method1(ctx context.Context, in *In) (*Out, error) {
	out := new(Out)
	err := c.cc.Invoke(ctx, "/servicedefs.Service/Method1", drpcEncoding_File_servicedefs_proto{}, in, out)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *drpcServiceClient) Method2(ctx context.Context) (DRPCService_Method2Client, error) {
	stream, err := c.cc.NewStream(ctx, "/servicedefs.Service/Method2", drpcEncoding_File_servicedefs_proto{})
	if err != nil {
		return nil, err
	}
...
func (x *drpcService_Method2Client) Send(m *In) error {
	return x.MsgSend(m, drpcEncoding_File_servicedefs_proto{})
}
...
func (x *drpcService_Method2Client) CloseAndRecv() (*Out, error) {
	...
	m := new(Out)
	if err := x.MsgRecv(m, drpcEncoding_File_servicedefs_proto{}); err != nil {
		return nil, err
	}
	return m, nil
}
...
func (x *drpcService_Method2Client) CloseAndRecvMsg(m *Out) error {
	...
	return x.MsgRecv(m, drpcEncoding_File_servicedefs_proto{})
}

func (c *drpcServiceClient) Method3(ctx context.Context, in *In) (DRPCService_Method3Client, error) {
	stream, err := c.cc.NewStream(ctx, "/servicedefs.Service/Method3", drpcEncoding_File_servicedefs_proto{})
	if err != nil {
		return nil, err
	}
	x := &drpcService_Method3Client{stream}
	if err := x.MsgSend(in, drpcEncoding_File_servicedefs_proto{}); err != nil {
		return nil, err
	}
	if err := x.CloseSend(); err != nil {
		return nil, err
...
func (c *drpcServiceClient) Method4(ctx context.Context) (DRPCService_Method4Client, error) {
	stream, err := c.cc.NewStream(ctx, "/servicedefs.Service/Method4", drpcEncoding_File_servicedefs_proto{})
	if err != nil {
		return nil, err
	}
...
func (DRPCServiceDescription) Method(n int) (string, drpc.Encoding, drpc.Receiver, interface{}, bool) {
	switch n {
	case 0:
		return "/servicedefs.Service/Method1", drpcEncoding_File_servicedefs_proto{},
	...
	case 1:
		return "/servicedefs.Service/Method2", drpcEncoding_File_servicedefs_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
	...
	case 2:
		return "/servicedefs.Service/Method3", drpcEncoding_File_servicedefs_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return nil, srv.(DRPCServiceServer).
					Method3(
						in1.(*In),
	...
	case 3:
		return "/servicedefs.Service/Method4", drpcEncoding_File_servicedefs_proto{},
			func(srv interface{}, ctx context.Context, in1, in2 interface{}) (drpc.Message, error) {
				return nil, srv.(DRPCServiceServer).
					Method4(
...
func (x *drpcService_Method1Stream) SendAndClose(m *Out) error {
	if err := x.MsgSend(m, drpcEncoding_File_servicedefs_proto{}); err != nil {
		return err
	}
	return x.CloseSend()
}
